//Customised Dynamic(Virtual) File System
...
int fstat_file(int fd)
{
     ...
     printf("\n-------------------------------Statistical Informaton about file-------------------------\n");
     printf("\nFile name : %s\n",temp->FileName);
   ...
   while(1)
   {
      ...
      else  if(count ==3)
      {
           ...
           else if(strcmp(command[0],"open")==0)
           {
              ...
              if(ret>=0)
              printf("\nFile is successfully opened with file descriptor : %d\n",ret);
              if(ret==-1)
                  printf("ERROR : Incorrect parameters\n");
              if(ret==-2)
